...
export class User {
    ...
    @OneToMany(()=>Flight, flight=>flight.user,{ onDelete: 'RESTRICT', onUpdate: 'RESTRICT' })
    flights:Flight[];



    @OneToMany(()=>Glider, glider=>glider.user,{ onDelete: 'RESTRICT', onUpdate: 'RESTRICT' })
    gliders:Glider[];



    @OneToMany(()=>Place, place=>place.user,{ onDelete: 'RESTRICT', onUpdate: 'RESTRICT' })
    places:Place[];
