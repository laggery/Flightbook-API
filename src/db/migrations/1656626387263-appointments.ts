...
export class appointments1656626387263 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), "appointment_id" integer, "user_id" integer, CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "scheduling" TIMESTAMP NOT NULL, "meeting_point" character varying NOT NULL, "max_people" integer, "description" character varying(2000), "state" character varying(25) NOT NULL, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), "school_id" integer, "instructor_id" integer, "takeoff_coordinator_id" integer, CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`);
